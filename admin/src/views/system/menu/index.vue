    ...
    <el-dialog v-model="formVisible" :title="formMode==='create'?'新增菜单':'编辑菜单'" width="560px" destroy-on-close>
      <el-form ref="formRef" :model="formData" :rules="rules" label-width="100px">
        ...
        <el-form-item label="父级" prop="parent_id">
          <el-tree-select v-model="formData.parent_id" :data="parentOptions" :props="({ label:'label', value:'id', children:'children' } as any)" check-strictly default-expand-all placeholder="顶级" clearable style="width:100%" />
        </el-form-item>
